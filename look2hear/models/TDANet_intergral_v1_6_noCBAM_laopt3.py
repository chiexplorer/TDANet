...
class TDANetEMCADv1_6_noCBAM_laopt3(BaseModel):
    def __init__(
        self,
        out_channels=128,
        in_channels=512,
        ...
        super(TDANetEMCADv1_6_noCBAM_laopt3, self).__init__(sample_rate=sample_rate)
...
if __name__ == '__main__':
    ...
    # TDANet测试
    feat_len = 2010
    model = TDANetEMCADv1_6_noCBAM_laopt3(sample_rate=sr, **model_configs)
