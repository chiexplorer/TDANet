...
from look2hear.models.EMCAD import EMCAD, EMCADF1
...
class UConvBlock(nn.Module):
    ...
    def __init__(self, out_channels=128, in_channels=512, upsampling_depth=4, feat_len=None):
        ...
        self.emcad = EMCADF1(channels=[in_channels]*upsampling_depth, feat_len=feat_len, expansion_factor=0.5, activation="prelu")
    ...
    def forward(self, x):
        ...
        # 插入EMCAD模块
        expanded = self.emcad(global_f, x_fused)
...
class TDANetEMCADF1(BaseModel):
    def __init__(
        ...
        super(TDANetEMCADF1, self).__init__(sample_rate=sample_rate)
...
if __name__ == '__main__':
    ...
    # TDANet测试
    feat_len = 3010
    model = TDANetEMCADF1(sample_rate=sr, **model_configs).cuda()
