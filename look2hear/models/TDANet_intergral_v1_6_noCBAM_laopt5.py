...
from look2hear.models.EMCAD_v1_6_noCBAM import EMCADv1_6_noCBAM
...
class UConvBlock(nn.Module):
    ...
    def __init__(self, out_channels=128, in_channels=512, upsampling_depth=4, feat_len=None):
        ...
        self.emcad = EMCADv1_6_noCBAM(channels=[in_channels]*upsampling_depth, feat_len=feat_len, expansion_factor=0.5, activation="prelu")
        ...
        for i in range(self.depth - 1):
            self.last_layer.append(LAOpt5(in_channels, in_channels, 5))
...
class TDANetEMCADv1_6_noCBAM_laopt5(BaseModel):
    def __init__(
        self,
        out_channels=128,
        in_channels=512,
        ...
        super(TDANetEMCADv1_6_noCBAM_laopt5, self).__init__(sample_rate=sample_rate)
...
if __name__ == '__main__':
    ...
    # TDANet测试
    feat_len = 2010
    model = TDANetEMCADv1_6_noCBAM_laopt5(sample_rate=sr, **model_configs)
