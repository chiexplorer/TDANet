...
from look2hear.models.EMCAD_v1_6_final import EMCADv1_6_Final
...
class UConvBlock(nn.Module):
    ...
    def __init__(self, out_channels=128, in_channels=512, upsampling_depth=4, feat_len=None):
        ...
        self.emcad = EMCADv1_6_Final(channels=[in_channels]*upsampling_depth, feat_len=feat_len, expansion_factor=0.5, activation="prelu")
...
class TDANetEMCADv1_6_Final(BaseModel):
    def __init__(
        self,
        out_channels=128,
        in_channels=512,
        ...
        super(TDANetEMCADv1_6_Final, self).__init__(sample_rate=sample_rate)
...
if __name__ == '__main__':
    ...
    # TDANet测试
    feat_len = 3010
    model = TDANetEMCADv1_6_Final(sample_rate=sr, **model_configs)
