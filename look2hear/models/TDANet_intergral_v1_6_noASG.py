...
from look2hear.models.EMCAD_v1_6_noASG import EMCADv1_6_noASG
...
class UConvBlock(nn.Module):
    ...
    def __init__(self, out_channels=128, in_channels=512, upsampling_depth=4, feat_len=None):
        ...
        self.emcad = EMCADv1_6_noASG(channels=[in_channels]*upsampling_depth, feat_len=feat_len, expansion_factor=0.5, activation="prelu")
