...
#   Efficient multi-scale convolutional attention decoding (EMCADNoInit)
class EMCADNoInit(nn.Module):
    def __init__(self, channels=[512, 320, 128, 64], kernel_sizes=[1, 3, 5], expansion_factor=6, dw_parallel=True,
        ...
        super(EMCADNoInit, self).__init__()
...
if __name__ == '__main__':
    ...
    channs = [512]*5
    model = EMCADNoInit(channels=channs, feat_len=x_len, expansion_factor=1).cuda()
