...
if __name__ == '__main__':
    fpath = r"D:\Projects\pyprog\TDANet\DataPreProcess\WSJ02mix\tr"
    data_configs = {
        "train_dir": fpath,
        "valid_dir": fpath,
        "test_dir": fpath,
    ...
    datamodule = WSJ0DataModule(**data_configs)
    datamodule.setup()
